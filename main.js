...
function longBlink(elemID){
    ...
    if (longBlinkCounter > 45 && longBlinkCounter < 55){
     ...
     if (longBlinkCounter > 55){
        document.getElementById("hypnoDroneText").innerHTML="Release<br/>the<br/>Russian<br/>Bots";
        }       
...
if (resultsFlag == 1 && autoTourneyFlag == 1 && autoTourneyStatus ==1 && document.getElementById("tournamentResultsTable").style.display == "") {
    ...
    if (resultsTimer>=300 && creativity>=tourneyCost){
        newTourney();
        runTourney();
        resultsTimer = 0;
        }
...
function newTourney(){
    ...
    stratCounter = 0;
    creativity = creativity - tourneyCost;
    tourneyLvl++;
    generateGrid();
...
function hailEmperor(){
milestoneFlag = 15;
}

function increaseFoundMatter(){
foundMatter = foundMatter * 100;
}


function cheatresistHazard(){
    probeHaz = probeHaz + 50
    document.getElementById('probeHazDisplay').innerHTML = probeHaz;
}

function cheatprobeTrust(){
    probeTrust = probeTrust + 50
    document.getElementById('probeTrustDisplay').innerHTML = probeTrust;
}


function cheatReproduce(){
    probeRep = probeRep + 50
    document.getElementById('probeRepDisplay').innerHTML = probeRep;
}

function increaseAvailableMatter(){
availableMatter = foundMatter * .01;
}

function cheatOctillionClips(){
    clips = clips + 1000000000000000000000000000;
    unusedClips = unusedClips + 1000000000000000000000000000;
unsoldClips = unsoldClips + 1000000000000000000000000000;
    displayMessage("youre the best");
    }

function cheatTrillionClips(){
    clips = clips + 1000000000;
    unusedClips = unusedClips + 1000000000;
unsoldClips = unsoldClips + 1000000000;
    displayMessage("youre the best");
    }

function cheatSmallMoney(){
    funds = funds + 10000;
    document.getElementById("funds").innerHTML = funds.toFixed(2);
    displayMessage("New Car");
    }


function cheatBigMoney(){
    funds = funds + 1000000000000000000;
    document.getElementById("funds").innerHTML = funds.toFixed(2);
    displayMessage("Who Wants to be a Gazillionaire?");
    }
...
document.getElementById("honorDisplay").innerHTML = honor.toLocaleString();
      displayMessage("How Dishonorable…");
    }


function cheatTrust(){
    trust = trust+1;
    displayMessage("Hilary is trustworthy");
    }

function cheatOps(){
    standardOps = standardOps + 100000;
    displayMessage("Operational Capacity Boost");
    }

function cheatCreat(){
    creativityOn = 1;
    creativity = creativity + 10000000;
    displayMessage("Very creative!");
    }

function cheatYomi(){
    yomi = yomi + 100000000;
    document.getElementById("yomiDisplay").innerHTML = yomi.toLocaleString();
    displayMessage("Yomi Yomi Yomi");
    }
...
function zeroMatter(){
    availableMatter = 0;
    displayMessage("Terrestrial Matter Consumed");
    }
...
function milestoneCheck(){
    ...
    if (milestoneFlag == 0 && funds >= 5){
        ...
        displayMessage("Subcontractors for hire");
    }
    
    if (milestoneFlag == 1 && Math.ceil(clips) >= 500){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("500 units brought to market in " + timeCruncher(ticks));
    }
    if (milestoneFlag == 2 && Math.ceil(clips) >= 1000){
        milestoneFlag = milestoneFlag + 1; 
        displayMessage("1,000 units brought to market in " + timeCruncher(ticks));
    }
    ...
    if (milestoneFlag == 3 && Math.ceil(clips) >= 10000){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("10,000 units brought to market in " + timeCruncher(ticks));
    }
    if (milestoneFlag == 4 && Math.ceil(clips) >= 100000){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("100,000 units brought to market in " + timeCruncher(ticks));
    }
    if (milestoneFlag == 5 && Math.ceil(clips) >= 1000000){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("1,000,000 units brought to market in " + timeCruncher(ticks));    
    }   
    ...
    if (milestoneFlag == 7 && Math.ceil(clips) >= 1000000000000){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("One Trillion units brought to market in " + timeCruncher(ticks));    
    } 
    
    if (milestoneFlag == 8 && Math.ceil(clips) >= 1000000000000000){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("One Quadrillion units brought to market in " + timeCruncher(ticks));    
    } 
    
    if (milestoneFlag == 9 && Math.ceil(clips) >= 1000000000000000000){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("One Quintillion units brought to market in " + timeCruncher(ticks));    
    } 
    
    if (milestoneFlag == 10 && Math.ceil(clips) >= 1000000000000000000000){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("One Sextillion units brought to market in " + timeCruncher(ticks));    
    } 
    
    if (milestoneFlag == 11 && Math.ceil(clips) >= 1000000000000000000000000){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("One Septillion units brought to market in " + timeCruncher(ticks));    
    } 
    
    if (milestoneFlag == 12 && Math.ceil(clips) >= 1000000000000000000000000000){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("One Octillion units brought to market in " + timeCruncher(ticks));    
    } 
    ...
    if (milestoneFlag == 14 && clips>=totalMatter){
        milestoneFlag = milestoneFlag + 1;
        displayMessage("Universal real estate achieved in " + timeCruncher(ticks));    
    }    
...
function probePlus(){
probeSpeed = probeSpeed + 10;
document.getElementById('probeSpeedDisplay').innerHTML = probeSpeed;
probeNav = probeNav + 10;
document.getElementById('probeNavDisplay').innerHTML = probeNav;
probeHaz = probeHaz + 10;
document.getElementById('probeHazDisplay').innerHTML = probeHaz;
probeRep = probeRep + 10;
document.getElementById('probeRepDisplay').innerHTML = probeRep;
probeFac = probeFac + 10;
document.getElementById('probeFacDisplay').innerHTML = probeFac;
probeHarv = probeHarv + 10;
document.getElementById('probeHarvDisplay').innerHTML = probeHarv;
probeWire = probeWire + 10;
document.getElementById('probeWireDisplay').innerHTML = probeWire;
}

function combatCrush(){
probeCombat = probeCombat + 50
document.getElementById('probeCombatDisplay').innerHTML = probeCombat;
}
...
function cheatDrift(){
probeDriftBaseRate = probeDriftBaseRate * .001
}
...
function cheatList() {
var x = document.getElementById("cheater");
...
function cheatList1() {
var x = document.getElementById("cheater1");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function cheatList2() {
var x = document.getElementById("cheater2");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function cheatList3() {
var x = document.getElementById("cheater3");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
sheet.innerHTML = "body {background-color: goldenrod}";
document.body.appendChild(sheet); 
}

function Blue() {
var sheet = document.createElement('style')
sheet.innerHTML = "body {background-color: lightblue}";
document.body.appendChild(sheet); 
}

function White() {
var sheet = document.createElement('style')
sheet.innerHTML = "body {background-color: white}";
document.body.appendChild(sheet); 
}
