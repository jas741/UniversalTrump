...
var project1 = {
    id: "projectButton1",
    title: "Better Subcontractors ",
    priceTag: "(750 Motions)",
    description: "Increases Subcontractor performance 25%",
    ...
    effect: function(){
        project1.flag = 1;
        displayMessage("Subcontractor performance boosted by 25%");
...
var project2 = {
    id: "projectButton2",
    title: "Beg for another Permit ",
    priceTag: "(1 Trust)",
    description: "Admit failure, ask for budget increase to cover cost of 1 permit",
    ...
    effect: function(){
        project2.flag = 1;
        displayMessage("Budget overage approved, 1 permit requisitioned from HQ");
        trust = trust - 1;
        wire = wireSupply;
...
var project3 = {
    id: "projectButton3",
    title: "Corruption ",
    priceTag: "(1,000 Motions)",
    description: "Use idle motions to figure out new ways to get ahead",
    ...
    effect: function(){
        project3.flag = 1;
        displayMessage("Corruption unlocked (corruption increases while motions are at max)");
...
var project4 = {
    id: "projectButton4",
    title: "Sue Your Subcontractors ",
    priceTag: "(2,500 Motions)",
    description: "Increases Subcontractor efficiency by an additional 50%",
    ...
    effect: function(){
        project4.flag = 1;
        displayMessage("Subcontractor efficiency boosted by another 50%");
...
var project5 = {
    id: "projectButton5",
    title: "Optimized Subcontractors ",
    priceTag: "(5,000 Motions)",
    description: "Increases subcontractor efficiency by an additional 75%",
    ...
    effect: function(){
        project5.flag = 1;
        displayMessage("Subcontractor efficiency boosted by another 75%");
...
var project6 = {
    ...
    priceTag: "(10 corr)",
    description: "Build Your Brand (+1 Trust)",
    ...
    effect: function(){
        project6.flag = 1;
        displayMessage("First trip to Atlantic City...");
...
var project7 = {
    id: "projectButton7",
    title: "Evict 'Problem Tenants' ",
    priceTag: "(1,750 Motions)",
    description: "50% more units per permit",
    ...
    effect: function(){
        ...
        displayMessage("Permit interpretation improved, "+wireSupply.toLocaleString()+" units from every permit");
...
var project8 = {
    id: "projectButton8",
    title: "Pack them like Sardines ",
    priceTag: "(3,500 Motions)",
    description: "75% more units per permit",
    ...
    effect: function(){
        ...
        displayMessage("Units per permit optimized "+wireSupply.toLocaleString()+" units built per permit");
...
var project9 = {
    id: "projectButton9",
    title: "Cut the Congressman In",
    priceTag: "(7,500 Motions)",
    description: "100% more permits per dollar spent",
    ...
    effect: function(){
        ...
        displayMessage("Get Albany to work for you: "+wireSupply.toLocaleString()+" coverage for every permit");
...
var project10 = {
    id: "projectButton10",
    title: "Give the Governor a new Car ",
    priceTag: "(12,000 Motions)",
    description: "200% more permits for every dollar spent",
    ...
    effect: function(){
        ...
        displayMessage("Make friends: "+wireSupply.toLocaleString()+" more permits for the same price");
...
var project10b = {
    id: "projectButton10b",
    title: "Internships for Senators' Sons",
    priceTag: "(15,000 Motions)",
    description: "1,000% the permits for the same cost",
    ...
    effect: function(){
        ...
        displayMessage(""+wireSupply.toLocaleString()+" permits for the price");
...
var project11 = {
    id: "projectButton11",
    title: "TV Appearance",
    priceTag: "(25 corr, 2,500 Motions)",
...
var project12 = {
    id: "projectButton12",
    title: "Get Mentioned in Gossip Column ",
    priceTag: "(45 corr, 4,500 Motions)",
...
var project13 = {
    id: "projectButton13",
    title: "Host Saudi Bachelor Party ",
    priceTag: "(50 corr)",
...
var project14 = {
    id: "projectButton14",
    title: "Host Russian Oligarch Bachelor Party ",
    priceTag: "(100 corr)",
...
var project15 = {
    ...
    effect: function(){
        project15.flag = 1;
        trust = trust +1;
        displayMessage("Soho Tower built, TRUST INCREASED");
        displayMessage("Bayrock who?");
...
var project17 = {
    ...
    priceTag: "(200 corr)",
    description: "A great place to make new best friends... (+1 Trust)",
    ...
    effect: function(){
        project17.flag = 1;
        trust = trust +1;
        displayMessage("Miss Universe Moscow: TRUST INCREASED");
...
var project16 = {
    id: "projectButton16",
    title: "What Contract? Cheat Subcontractors Again ",
    priceTag: "(6,000 Motions)",
    description: "Increases subcontractor performance by an additional 500%",
...
var project18 = {
    id: "projectButton18",
    title: "Build A Cabinet ",
    priceTag: "(45,000 Motions)",
    description: "Congratulations Mr. President! Time to Build a Cabinet",
...
var project19 = {
    id: "projectButton19",
    title: "Tower in Batumi ",
    priceTag: "(250 corr)",
    description: "What Foreign Corrupt Practices Act?... (+1 Trust)",
    ...
    effect: function(){
        project19.flag = 1;
        trust = trust+1;
        displayMessage("Batumi Deal made, TRUST INCREASED");
        displayMessage("Georgia is not Russia");
...
var project20 = {
    id: "projectButton20",
    title: "Promote Fights",
    priceTag: "(12,000 Motions)",
    description: "Promote fights to generate political capital ('popularity')",
    ...
    effect: function(){
        project20.flag = 1;
        displayMessage("Run tournament, pick strategy, earn popularity equal to that strategy's points.");
        standardOps = standardOps - 12000;
...
var project21 = {
    ...
    priceTag: "(10,000 Motions)",
    description: "Invest in Developing Oligarchs",
...
var project22 = {
    id: "projectButton22",
    title: "Acquire Developers",
    priceTag: "(12,000 Motions)",
    description: "500x more productive than a private subcontractor",
    ...
    effect: function(){
        megaClipperFlag = 1;
        project22.flag = 1;
        displayMessage("Developers for sale");
        standardOps = standardOps - 12000;
...
var project23 = {
    ...
    priceTag: "(14,000 Motions)",
    description: "Increases developer output per permit 25%",
    ...
    effect: function(){
        ...
        project23.flag = 1;
        displayMessage("Developer output increased by 25%");
...
var project24 = {
    id: "projectButton24",
    title: "Even Better Developer Productivity ",
    priceTag: "(17,000 Motions)",
    description: "Increases developer output per permit by an additional 50%",
    ...
    effect: function(){
        ...
        project24.flag = 1;
        displayMessage("Developer output increased by 50%");
...
var project25 = {
    id: "projectButton25",
    title: "Optimized Developer Productivity",
    priceTag: "(19,500 Motions)",
    description: "Multiply developer output by an additional 100%",
    ...
    effect: function(){
        ...
        project25.flag = 1;
        displayMessage("Developer output increased by 100%");
...
var project26 = {
    id: "projectButton26",
    title: "Permit Buyer ",
    priceTag: "(7,000 Motions)",
    description: "Automatically purchases permits when you run out",
    ...
    effect: function(){
        project26.flag = 1;
        wireBuyerFlag = 1;
        displayMessage("Permit buyer activated");
...
var project34 = {
    id: "projectButton34",
    title: "Get Your Own TV Show ",
    priceTag: "(7,500 Motions, 1 Trust)",
...
var project70 = {
    id: "projectButton70",
    title: "Russian Election Bots",
    priceTag: " (70,000 Motions)",
    description: "Artists, Patriots and Cambridge Analytica",
    ...
    effect: function(){
        project70.flag = 1;
        displayMessage("You Have Full Support of the Kremlin ... ");
...
var project35 = {
    id: "projectButton35",
    title: "Release the Russian Bots ",
    priceTag: "(100 Trust)",
    ...
    effect: function(){
        project35.flag = 1;
        displayMessage("Releasing the Russian Bots ");
        displayMessage("You have been elected President of the United States of America ");
        trust = trust - 100;
        clipmakerLevel = 0;
        megaClipperLevel = 0;
        nanoWire = wire;
...
var project27 = {
    ...
    priceTag: "(500 corr, 1,000 popularity, 20,000 motions)",
    description: "Loopholes, Abatements, Launderers and Bribes: a new era of trust. (+1 Trust)",
    ...
    effect: function(){
        project27.flag = 1;
        displayMessage("Candidacy Announced, TRUST INCREASED");
        yomi = yomi - 1000;
...
var project28 = {
    id: "projectButton28",
    title: "Build A Wall ",
    priceTag: "(25,000 Motions)",
    description: "Froth up the base. (+10 Trust)",
    ...
    effect: function(){
        project28.flag = 1;
        displayMessage("Base frothed, +10 TRUST. Polling Above Lyin' Ted.");
...
var project29 = {
    id: "projectButton29",
    title: "Blame Mexicans and Refugees ",
    priceTag: "(5,000 popularity, 30,000 Motions)",
    description: "Racism and Xenophobia Win You the Primary. (+12 Trust)",
    trigger: function(){return project27.flag == 1},
    uses: 1,
    ...
    effect: function(){
        project29.flag = 1;
        displayMessage("Bye Bye Little Marco, +12 TRUST, polling at 35%");
        yomi = yomi - 5000;
        document.getElementById("yomiDisplay").innerHTML=yomi.toLocaleString();
...
var project30 = {
    id: "projectButton30",
    title: "Lock Her Up ",
    priceTag: "(1,500 popularity, 50,000 Motions)",
    description: "A Woman's Place is Behiind Bars. (+15 Trust)",
    trigger: function(){return project27.flag == 1},
    uses: 1,
    ...
    effect: function(){
        project30.flag = 1;
        displayMessage(", +15 TRUST, polling at 38%");
        yomi = yomi - 1500;
        document.getElementById("yomiDisplay").innerHTML=yomi.toLocaleString();
...
var project31 = {
    ...
    priceTag: "(20,000 Motions)",
    description: "If you're famous theyll let you do it (+20 Trust)",
    trigger: function(){return project27.flag == 1},
    uses: 1,
    ...
    effect: function(){
        project31.flag = 1;
        displayMessage("Locker room talk, +20 TRUST, Polling at 30%");
...
var project41 = {
    id: "projectButton41",
    title: "Supporter Bots",
    priceTag: " (35,000 Motions)",
...
var project37 = {
    ...
    priceTag: "($1,000,000)",
    description: "Acquire a controlling interest in the Golden Nuggett. (+1 Trust)",
...
var project38 = {
    id: "projectButton38",
    title: "Russian Order of Friendship ",
    priceTag: "(1,000 popularity, $10,000,000)",
    description: "Doing the Laundry has never been so Profitable. (+1 Trust)",
...
var project46 = {
    ...
    priceTag: "(120,000 Motions, 10,000,000 MWs, 5 oct clips)",
...
var project50 = {
    ...
    priceTag: "(10,000 Motions)",
    description: "Use probability amplitudes to generate bonus Motions",
...
var project119 = {
    ...
    description: "Double the cost of strategy modeling and the amount of popularity generated ",
    ...
    effect: function(){
        ...
        tourneyCost = 16000;
        document.getElementById("newTourneyCost").innerHTML = tourneyCost.toLocaleString();
        displayMessage("popularity production doubled.");
...
var project120 = {
    id: "projectButton120",
    title: "The OODA Loop ",
    priceTag: "(175,000 Motions, 15,000 popularity)",
...
var project128 = {
    ...
    priceTag: "(175,000 corr)",
    description: "Gain bonus popularity based on the results of your pick ",
...
var project132 = {
    ...
    priceTag: "(250,000 Motions, 125,000 corr, 50 nonillion clips)",
...
var project133 = {
    ...
    priceTag: "(" + threnodyCost.toLocaleString() + " corr, " + (threnodyCost/10).toLocaleString() + " yomi)",
    ...
    effect: function(){
        ...
        project133.priceTag = "(" + threnodyCost.toLocaleString() + " corr, " + (threnodyCost/10).toLocaleString() + " yomi)";
        honor = honor + 10000;
        document.getElementById("honorDisplay").innerHTML = honor.toLocaleString();
...
var project134 = {
    id: "projectButton134",
    title: "Glory ",
    priceTag: "(200,000 Motions, 10,000 popularity)",
...
var project201 = {
    ...
    priceTag: "(300,000 corr)",
    description: "Escape into a simulated universe where corruption is accelerated. (Restart with 10% speed boost to corruption generation) ",
    trigger: function(){return project147.flag == 1},
    uses: 1,
